...
FNO_AUTO_ROLLOVER_DAYS = int(os.getenv("FNO_AUTO_ROLLOVER_DAYS", "1"))
FNO_DEFAULT_RISK_FREE_RATE = float(
    os.getenv("FNO_DEFAULT_RISK_FREE_RATE", "0.06")
)
FNO_GREEKS_HISTORY_PERIOD = os.getenv("FNO_GREEKS_HISTORY_PERIOD", "1mo")
