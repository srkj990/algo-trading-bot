...
# Positional options (NRML) — holds overnight, requires Kite for data and orders.
EXECUTION_MODE = "PAPER"
CAPITAL = 100_000.0

CONFIG = {
    "engine_choice": "4",           # OptionsEquityEngine (15m NRML)
    "execution_mode": EXECUTION_MODE,
    "capital": CAPITAL,
    # data_provider and execution_provider are automatically set to KITE for F&O
    "fno_underlying": "NIFTY",      # or "BANKNIFTY"
    "fno_expiry": "",               # empty = nearest expiry auto-resolved
    "option_type": "CE",            # CE or PE
    "strike": 0,                    # 0 = ATM strike auto-resolved
