...
# Buyer Only (long CE). Override via the first CLI arg if needed, e.g.
# `main.py 6`.
ENGINE_CHOICE = sys.argv[1] if len(sys.argv) > 1 else "7"

CONFIG = {
    "engine_choice": ENGINE_CHOICE,         # IntradayOptionsBuyerEngine (1m MIS)
