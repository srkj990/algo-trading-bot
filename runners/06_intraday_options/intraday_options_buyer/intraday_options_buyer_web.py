...
# Buyer Only (long CE). Pre-selects the Engine dropdown in the web UI.
# Override via the second CLI arg if needed, e.g. `main_web.py 8087 6`.
ENGINE_CHOICE = sys.argv[2] if len(sys.argv) > 2 else "7"
