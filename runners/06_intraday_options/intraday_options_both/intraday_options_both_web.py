...
# Buy & Sell Both, single combined pool. Pre-selects the Engine dropdown in
# the web UI. Override via the second CLI arg if needed, e.g.
# `main_web.py 8086 7`.
ENGINE_CHOICE = sys.argv[2] if len(sys.argv) > 2 else "6"
